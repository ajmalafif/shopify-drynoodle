...
$('.wishlist-btn').on( "click", function() {
    ...
    function NotificationWishlist(){
      $('#NotificationWishlist').attr('aria-hidden', false).addClass('notification--active');
      setTimeout(function() { $("#NotificationWishlist").removeClass('notification--active'); }, 5000);
    }

    if ($('.wishlist-btn').hasClass('is-active')) {
